...
case "${MODEL}" in
    ...
    pairmixer)
        ...
        BATCH_SIZE=${BATCH_SIZE:-32}
        ;;
    pairmixer_auto|pairmixer_12M|pairmixer_16M|pairmixerpp_12M)
        BATCH_SIZE=${BATCH_SIZE:-32}
        ;;
    pairmixer_10M)
        DIM=${DIM:-256}
...
case "${MODEL}" in
    ...
    pairmixer)        DIM_FLAGS="" ;;
    pairmixer_auto|pairmixer_12M|pairmixer_16M|pairmixerpp_12M)   DIM_FLAGS="" ;;  # dims set in model config
