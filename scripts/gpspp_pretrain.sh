...
CUDA_VISIBLE_DEVICES=$DEVICE graphium-train \
    ...
    # ++datamodule.args.task_specific_args.qm9.smiles_col='smiles' \
    # ++datamodule.args.task_specific_args.qm9.label_cols="['A', 'B', 'C', 'mu', 'alpha', 'homo', 'lumo', 'gap', 'r2', 'zpve', 'u0', 'u298', 'h298', 'g298', 'cv', 'u0_atom', 'u298_atom', 'h298_atom', 'g298_atom']" \
    # ++datamodule.args.task_specific_args.qm9.task_level=graph \
    ...
    # ++datamodule.args.task_specific_args.tox21.smiles_col='smiles' \
    # ++datamodule.args.task_specific_args.tox21.label_cols="['NR-AR', 'NR-AR-LBD', 'NR-AhR', 'NR-Aromatase', 'NR-ER', 'NR-ER-LBD', 'NR-PPAR-gamma', 'SR-ARE', 'SR-ATAD5', 'SR-HSE', 'SR-MMP', 'SR-p53']" \
    # ++datamodule.args.task_specific_args.tox21.task_level=graph \
    ...
    # ++datamodule.args.task_specific_args.zinc.smiles_col='smiles' \
    # ++datamodule.args.task_specific_args.zinc.label_cols="['SA', 'logp', 'score']" \
    # ++datamodule.args.task_specific_args.zinc.task_level=graph \
