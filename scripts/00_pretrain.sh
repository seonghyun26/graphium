...
case "${MODEL}" in
    ...
    pairformer_boltz)
        ...
        BATCH_SIZE=${BATCH_SIZE:-32}
        ;;
    pairmixer_auto|pairmixer_12M|pairmixer_16M|pairmixer_10M|pairmixer_10M_vn|pairmixer_20M|pairmixer_20M_pairinit_*|pairmixer_40M|pairmixer_50M|pairmixer_100M|pairmixer_boltz|pairmixer_boltz_moe)
...
case "${MODEL}" in
    ...
    pairmixer_auto|pairmixer_12M|pairmixer_16M|pairmixer_10M|pairmixer_10M_vn|pairmixer_20M|pairmixer_20M_pairinit_*|pairmixer_40M|pairmixer_50M|pairmixer_100M|pairmixer_boltz|pairmixer_boltz_moe)  DIM_FLAGS="" ;;
esac
...
DEPTH_FLAGS=""
case "${MODEL}" in
    gpspp_800M|gpspp_800M_moe|gpspp_768|pairformer|pairformer_17M|pairformer_52M|pairformer_boltz|pairmixer_auto|pairmixer_12M|pairmixer_16M|pairmixer_10M|pairmixer_10M_vn|pairmixer_20M|pairmixer_20M_pairinit_*|pairmixer_40M|pairmixer_50M|pairmixer_100M|pairmixer_boltz|pairmixer_boltz_moe)
