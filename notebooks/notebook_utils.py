...
TDC_SOTA = {
    ...
    'bioavailability_ma':               (0.770, 0.000, 'Boltz2Mini.'),
    'lipophilicity_astrazeneca':        (0.386, 0.000, 'MolGPS(paper)'),
    'solubility_aqsoldb':               (0.640, 0.000, 'Boltz2Mini.'),
    'bbb_martins':                      (0.941, 0.000, 'MolGPS(paper)'),
    'ppbr_az':                          (6.464, 0.000, 'MolGPS(paper)'),
    'vdss_lombardo':                    (0.750, 0.000, 'Boltz2Mini.'),
    'cyp2c9_veith':                     (0.860, 0.000, 'Boltz2Mini.'),
    'cyp2d6_veith':                     (0.790, 0.001, 'MapLight + GNN'),
    'cyp3a4_veith':                     (0.916, 0.000, 'MapLight + GNN'),
    'cyp2c9_substrate_carbonmangels':   (0.519, 0.036, 'QIP'),
    'cyp2d6_substrate_carbonmangels':   (0.737, 0.024, 'KPGT'),
    'cyp3a4_substrate_carbonmangels':   (0.730, 0.023, 'MolGPS(paper)'),
    'half_life_obach':                  (0.650, 0.000, 'Boltz2Mini.'),
    'clearance_hepatocyte_az':          (0.620, 0.000, 'Boltz2'),
    'clearance_microsome_az':           (0.658, 0.005, 'QIP'),
    'ld50_zhu':                         (0.400, 0.000, 'Boltz2'),
    'herg':                             (0.880, 0.002, 'MapLight + GNN'),
    'ames':                             (0.910, 0.000, 'Boltz2'),
    'dili':                             (0.956, 0.006, 'MiniMol'),
}

# Boltz2 / Boltz2Mini per-task ADMET results from
# "Boltz is a Strong Baseline for Atom-level Representation Learning" (preprint, 2026), Table 1.
# Values are reported at 2-decimal precision; std not reported.
BOLTZ2 = {
    'caco2_wang':                       (0.30, 0.0),
    'hia_hou':                          (0.99, 0.0),
    'pgp_broccatelli':                  (0.93, 0.0),
    'bioavailability_ma':               (0.75, 0.0),
    'lipophilicity_astrazeneca':        (0.45, 0.0),
    'solubility_aqsoldb':               (0.66, 0.0),
    'bbb_martins':                      (0.93, 0.0),
    'ppbr_az':                          (7.65, 0.0),
    'vdss_lombardo':                    (0.74, 0.0),
    'cyp2c9_veith':                     (0.82, 0.0),  # * improved with protein context (Table 6)
    'cyp2d6_veith':                     (0.69, 0.0),  # *
    'cyp3a4_veith':                     (0.85, 0.0),  # *
    'cyp2c9_substrate_carbonmangels':   (0.36, 0.0),
    'cyp2d6_substrate_carbonmangels':   (0.52, 0.0),
    'cyp3a4_substrate_carbonmangels':   (0.62, 0.0),
    'half_life_obach':                  (0.62, 0.0),
    'clearance_hepatocyte_az':          (0.62, 0.0),
    'clearance_microsome_az':           (0.61, 0.0),
    'ld50_zhu':                         (0.40, 0.0),
    'herg':                             (0.86, 0.0),
    'ames':                             (0.91, 0.0),
    'dili':                             (0.89, 0.0),
...
BOLTZ2_MINI = {
    ...
    'hia_hou':                          (0.99, 0.0),
    'pgp_broccatelli':                  (0.93, 0.0),
    'bioavailability_ma':               (0.77, 0.0),
    'lipophilicity_astrazeneca':        (0.41, 0.0),
    'solubility_aqsoldb':               (0.64, 0.0),
    'bbb_martins':                      (0.94, 0.0),
    'ppbr_az':                          (7.59, 0.0),
    'vdss_lombardo':                    (0.75, 0.0),
    'cyp2c9_veith':                     (0.86, 0.0),
    'cyp2d6_veith':                     (0.72, 0.0),
    'cyp3a4_veith':                     (0.88, 0.0),
    'cyp2c9_substrate_carbonmangels':   (0.36, 0.0),
    'cyp2d6_substrate_carbonmangels':   (0.51, 0.0),
    'cyp3a4_substrate_carbonmangels':   (0.60, 0.0),
    'half_life_obach':                  (0.65, 0.0),
    'clearance_hepatocyte_az':          (0.60, 0.0),
    'clearance_microsome_az':           (0.65, 0.0),
    'ld50_zhu':                         (0.40, 0.0),
    'herg':                             (0.86, 0.0),
    'ames':                             (0.91, 0.0),
    'dili':                             (0.87, 0.0),
